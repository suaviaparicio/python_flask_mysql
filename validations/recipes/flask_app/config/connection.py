...
class MySQLConnection:
    def __init__(self, db):
        ...
        connection = pymysql.connect(
            ...
            db=db, #'compendio_flask' (nombre de la base de datos)
            charset='utf8mb4',
...
def connectToMySQL(db_name): #se debe borrar el parámetro si se pone el nombre de la base de dato
    return MySQLConnection(db_name) #se debe borrar el parámetro si se pone el nombre de la base de dato
